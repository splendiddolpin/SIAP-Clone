...
<body>
  ...
  if (isset($_POST['kembali'])) {
    header("location:profil_operator.php?nip=$NIP");
    exit;
  }
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($alamat == '' || $no_telp == '') {
      ...
      $update = "UPDATE operator SET alamat = '$alamat', no_telp = '$no_telp' WHERE NIP = '$NIP'";
    ...
    mysqli_query($koneksi, "UPDATE operator SET foto = '$file_foto' WHERE NIP = '$NIP'");
      }
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        ...
        $query_profil = "SELECT * FROM operator WHERE NIP = '$NIP'";
        ...
        <span class="admin_name"><?= $data_profil->nama_op ?><br>Operator</span>
      ...
      <div class="sales-boxes">
        ...
        <div class="recent-sales box" style="padding-bottom: 100px;">
          ...
          <div class="sales-details" style="margin-left: 50px; margin-right: 50px;">
            ...
            $op = $koneksi->query($query);

            while ($data_op = $op->fetch_object()) :
            ...
            ?>
              ...
              <ul class="details">
                ...
                <li><?= $data_op->NIP ?></li>
                <li><?= $data_op->nama_op ?></li>
                <li><input name="alamat" style="border-radius: 5px; width:215px;" type="text" size="10" value="<?= $data_op->alamat ?>"></li>
              </ul>
              ...
              <ul class="details">
                <li><?= $data_op->email ?></li>
                <li><input name="no_telp" style="border-radius: 5px;width:215px;" type="text" size="10" value="<?= $data_op->no_telp ?>"></li>
              </ul>
