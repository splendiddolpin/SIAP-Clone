        ...
        <div class="recent-sales box" style="padding-bottom: 100px; ">
          ...
          <div>
            <table class="customers">
              ...
              <?php 
              $query = "SELECT nama_mhs, angkatan, pkl.* FROM mahasiswa, pkl WHERE mahasiswa.NIM = pkl.NIM AND NIP_dospem_pkl = '$NIP' ORDER BY status, smt DESC";
              $result = $koneksi->query( $query );
              if (!$result){
                ...
                while ($row = $result->fetch_object()){ ?>
                  <tr>
                    ...
                    <td>
                    <!-- tombol validasi -->
                    <a href="update_data.php?val=<?php echo 'check_pkl'; ?>&nip=<?php echo $NIP; ?>&nim=<?php echo $row->NIM; ?>" style="color: #081D45; border:none;"><i class='bx bxs-check-circle bx-sm'></i></a>
                    <a href="update_data.php?val=<?php echo 'uncheck_pkl'; ?>&nip=<?php echo $NIP; ?>&nim=<?php echo $row->NIM; ?>" style="color: #081D45; border:none;"><i class='bx bx-window-close bx-sm'></i></a>
                    <!-- tombol edit -->
                    <a href="ver_pkl_edit.php?nip=<?php echo $NIP; ?>&nim=<?php echo $row->NIM; ?>"  style="color: #081D45;"><i class='bx bxs-pencil bx-sm'></i></a>
                    <!-- tombol view -->
                    <a href="view_doc.php?val=<?php echo 'pkl' ?>&nip=<?php echo $NIP ?>&nim=<?php echo $row->NIM;?>" style="color: #081D45;"><i class='bx bxs-file-find bx-sm' ></i></a>
                    </td>
                  </tr>
              <?php      
                }
