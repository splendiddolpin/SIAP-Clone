        ...
        <div class="recent-sales box" style="padding-bottom: 100px; ">
          ...
          <?php 
              ...
              $query = "SELECT nama_mhs, angkatan, skripsi.*
                        FROM mahasiswa, skripsi WHERE mahasiswa.NIM='$NIM' AND mahasiswa.NIM = skripsi.NIM";
              $result = $koneksi->query( $query );
              if (!$result){
          ...
          <div>
            ...
            if (isset($_POST['simpan'])){
              ...
              $query = "UPDATE skripsi SET smt = '$smt', nilai_skripsi='$nilai_skripsi', tgl_sidang='$tgl_sidang' WHERE NIM='$NIM';";
              $result = $koneksi->query( $query );
              if (!$result){
                    die ("Could not query the database: <br />". $koneksi->error);
              }
            ...
            <form method="POST">
              <table style="margin-top:20px">
                ...
                <tr>
                  <td style="text-align:left">Lama Studi (Semester)</td>
                  <td style="padding: 0px 5px">:</td>
                  <td><input style="width:50px" type="text" name="smt" id="smt" value="<?php echo $row->smt?>"></td>
                </tr>
                <tr>
                  <td style="text-align:left">Nilai Skripsi</td>
                  <td style="padding: 0px 5px">:</td>
                  <td><input style="width:50px" type="text" name="nilai_skripsi" id="nilai_skripsi" value="<?php echo $row->nilai_skripsi?>"></td>
                </tr>
                <tr>
                  <td style="text-align:left">Tanggal Sidang</td>
                  <td style="padding: 0px 5px">:</td>
                  <td><input style="width:100px" type="date" name="tgl_sidang" id="tgl_sidang" value="<?php echo $row->tgl_sidang?>"></td>
                </tr>
