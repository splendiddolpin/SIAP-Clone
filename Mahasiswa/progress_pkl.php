      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            <ul class="details">
              <li><a >Status PKL</a></li>
              <li><a >Nilai PKL</a></li>
              <li><a >Scan Berita Acara</a></li>
            </ul>
            <ul class="details">
              <li><a >:</a></li>
              <li><a >:</a></li>
            ...
            <ul class="details">
              ...
              <li><input type="text" name="nilai" value="<?= $arr_pkl['nilai_pkl']; ?>"></li>
            ...
            <?php
            $nilai = mysqli_query($koneksi, "SELECT nilai_pkl FROM pkl
            WHERE pkl.NIM = '$NIM'; ");
            ...
            if(isset($_POST['proses'])){
                ...
                mysqli_query($koneksi, "update pkl set file_pkl='$file_name', nilai_pkl='$nilai' where NIM='$NIM' ");
            ...
            <div class="top-sales box">
              <table>
                ...
                <ul class="top-sales-details">
                  ...
                  <?php endwhile?>
                  <?php
                  echo '<a href="scanpkl.php?nim='.$NIM.'" class="tombol">Scan</a>';
                  echo '<a href="pkl.php?nim='.$NIM.'" class="tombol">Kembali</a>';
                  ?>
                </ul>
              </div>
              </tr>
