        ...
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            ...
            if(isset($_POST['proses'])){
                ...
                //cek apakah NIM dengan semester ini sudah ada di database 
                $count=mysqli_query($koneksi, "SELECT count(*) AS cek FROM irs where NIM='$NIM' and smt='$smt'");
                $cek = mysqli_fetch_array($count);
                if ($cek['cek']>0){
                  mysqli_query($koneksi, "update irs set file_irs='$file_name', validasi='Belum Divalidasi' where NIM='$NIM' and smt='$smt'");
                  echo "File Berhasil Diupload";
                }
                else{
                  mysqli_query($koneksi, "INSERT INTO irs (NIM, smt, file_irs, validasi) VALUES ('$NIM', '$smt', '$file_name', 'Belum Divalidasi')");
                  echo "File Berhasil Diupload";
                }
