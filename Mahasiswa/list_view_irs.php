...
<body>
  ...
  if(isset($_SESSION['alert'])){
    echo '<script>alert("Anda belum upload file IRS semester ini!");</script>';
  }
  ...
  <nav>
    ...
    <div class="home-content">
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          <div class="title">IRS</div>
          <div class="sales-details">
            <table class="customers">
                <tr>
                    <th colspan="7" style="text-align: center;">Pilih Semester</th>
                </tr>
                <tr>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=1" class="tombol"> 1</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=2" class="tombol"> 2</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=3" class="tombol"> 3</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=4" class="tombol"> 4</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=5" class="tombol"> 5</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=6" class="tombol"> 6</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=7" class="tombol"> 7</a></td>
                </tr>
                <tr>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=8" class="tombol"> 8</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=9" class="tombol"> 9</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=10" class="tombol"> 10</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=11" class="tombol"> 11</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=12" class="tombol"> 12</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=13" class="tombol"> 13</a></td>
                    <td><a href="view_irs.php?nim=<?php echo $NIM; ?>&smt=14" class="tombol"> 14</a></td>
                </tr>
            </table>
          </div>
    ...
    <div class="top-sales box">
            ...
            <ul class="top-sales-details">
                  ...
                  <?php endwhile?>
                  <?php
                  echo '<a href="irs.php?nim='.$NIM.'" class="tombol">Kembali ke IRS</a>';
                  ?>
                </ul>
              </div>
          </div>
