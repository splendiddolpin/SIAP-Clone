...
<form action="" method="post" enctype="multipart/form-data">
  <div class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li>
        <?php 
        echo '<a href="skripsi.php?nim='.$NIM.'" class="active">';
        echo '<i class="bx bx-file"></i>';
  ...
  <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Skripsi</span>
      </div>
      ...
      <div class="sales-boxes">
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            ...
            <ul class="details">
              <li><a ><?= $arr_skripsi['status']; ?></a></li>
              <li><input type="text" name="nilai" value="<?= $arr_skripsi['nilai_skripsi']; ?>"></li>
            ...
            <?php
            $nilai = mysqli_query($koneksi, "SELECT nilai_skripsi FROM skripsi
            WHERE skripsi.NIM = '$NIM'; ");
            ...
            if(isset($_POST['proses'])){
                ...
                mysqli_query($koneksi, "update skripsi set file_skripsi='$file_name', nilai_skripsi='$nilai' where NIM='$NIM' ");
            ...
            <div class="top-sales box">
              ...
              <table>
                ...
                <div class="title">Isi Skripsi</div>
                <!-- <tr class="top-sales-details">
                  <td><a href="#">
                    <img src="images/Profile.jpg" alt=""> -->
                    <!-- <span class="product">Ahmad Isa</span> -->
                  <!-- </a></td>
                  <td><span class="product">Ahmad Isa</span><br><span class="price">24060120140077</span></td>
                </tr> -->
                <ul class="top-sales-details">
                  <li>
                    <a href="#">
                      <img src="images/<?= $arr_mhs['foto']; ?>" alt="">
                      <!-- <span class="product">Ahmad Isa</span><br>
                  ...
                  <?php endwhile?>
                  <?php
                  echo '<a href="scanskripsi.php?nim='.$NIM.'" class="tombol">Scan</a>';
                  echo '<a href="skripsi.php?nim='.$NIM.'" class="tombol">Kembali</a>';
                  ?>
                </ul>
              </div>
              </tr>
