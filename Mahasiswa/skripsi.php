        ...
        <div class="recent-sales box">
          ...
          <div class="sales-details">
            ...
            <ul class="details">
              ...
              <li><a><?= $arr_skripsi['nilai_skripsi']; ?></a></li>
            ...
            <div class="top-sales box">
              ...
              <table>
                ...
                <ul class="top-sales-details">
                  ...
                  <?php endwhile?>
                  <?php
                  echo '<a href="scanskripsi.php?nim='.$NIM.'" class="tombol">View</a>';
                  echo '<a href="skripsiProgress.php?nim='.$NIM.'" class="tombol">Progress</a>';
                  ?>
                </ul>
              </div>
              </tr>
