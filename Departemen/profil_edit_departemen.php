...
<body>
  ...
  if (isset($_POST['kembali'])) {
    header("location:profil_departemen.php?nip=$NIP");
    exit;
  }
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($alamat == '' || $no_telp == '') {
      ...
      $update = "UPDATE departemen SET alamat = '$alamat', no_telp = '$no_telp' WHERE NIP = '$NIP'";
    ...
    mysqli_query($koneksi, "UPDATE departemen SET foto = '$file_foto' WHERE NIP = '$NIP'");
      }
  ...
  <section class="home-section">
    <nav>
      ...
      <div class="profile-details">
        ...
        $query_profil = "SELECT * FROM departemen WHERE NIP = '$NIP'";
        ...
        <span class="admin_name"><?= $data_profil->nama_dept ?><br>Departemen</span>
      ...
      <div class="sales-boxes">
        ...
        <div class="recent-sales box" style="padding-bottom: 100px;">
          ...
          <div class="sales-details" style="margin-left: 50px; margin-right: 50px;">
            ...
            $dept = $koneksi->query($query);

            while ($data_dept = $dept->fetch_object()) :
            ...
            ?>
              ...
              <ul class="details">
                ...
                <li><?= $data_dept->NIP ?></li>
                <li><?= $data_dept->nama_dept ?></li>
                <li><input name="alamat" style="border-radius: 5px; width:215px;" type="text" size="10" value="<?= $data_dept->alamat ?>"></li>
              </ul>
              ...
              <ul class="details">
                <li><?= $data_dept->email ?></li>
                <li><input name="no_telp" style="border-radius: 5px;width:215px;" type="text" size="10" value="<?= $data_dept->no_telp ?>"></li>
              </ul>
