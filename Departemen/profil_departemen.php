  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Profil Departemen</span>
      </div>
      <?php 
    ...
    <div class="home-content">
      <div class="sales-boxes">
        <div class="recent-sales box" style="padding-bottom: 100px; ">
          ...
          <div>
            <a href="profil_edit_departemen.php?nip=<?php echo $NIP ?>" class="save-btn update-profil">Edit Profil</a>
          </div>
        </div>
      </div>
    </div>
